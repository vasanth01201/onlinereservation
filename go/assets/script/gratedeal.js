...
$(document).ready(function() {
{
    ...
    class Slide {
        ...
        initEvents() {
            this.mouseenterFn = () => {
                ...
                if ( this.isPositionedCenter() ) {
                    this.zoom({scale: 1.2, speed: 10, ease: 'Quad.easeOut'});
            ...
            this.mouseleaveFn = () => {
                ...
                if ( this.isPositionedCenter() ) {
                    this.zoom({scale: 1.1, speed: 10, ease: 'Quad.easeOut'});
                    // TweenMax.to(this.DOM.explore.querySelector('.slide__explore-inner'), 0.3, {
                    //     startAt: {y: '100%'},
                    //     y: '0%'
                    // });
        ...
        setCurrent(hideBefore = true) {
            ...
            if ( hideBefore ) {
                ...
                this.DOM.titleWrap.style.opacity = 0; //new
        ...
        setLeft(hideBefore = true) {
            ...
            // this.DOM.el.classList.add('slide--left', 'slide--visible'); // off slide no #3
        }
        // Set the class right.
        ...
        toggleTexts(action, direction, delay) {
            if ( this.isPositionedCenter() ) {
                this.DOM.titleWrap.style.transformOrigin = this.DOM.titleBox.style.transformOrigin = this.DOM.subtitleBox.style.transformOrigin = action === 'hide' ? '100% 50%' : '0% 50%';
                ...
                TweenMax.to(this.DOM.titleWrap, speed, {
                    ease: ease,
                    delay: action === 'hide' ? delay + 0.9 : delay,
                    startAt: action === 'show' ? {scaleX: 0} : {},
                    scaleX: action === 'hide' ? 0 : 1,
                    opacity: 1
                });
    ...
    if (document.querySelector('.slideshow')) {
        ...
        imagesLoaded(document.querySelector('.slide__img'), () => {
            setTimeout(() => {
    ...
    // --------------------------------------------
    // paly and pause action is's working on main.js
    // --------------------------------------------
    // $(function(){
