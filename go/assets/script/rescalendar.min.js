  ...
  t.fn.rescalendar = function(a) {
          ...
          a.find('.rescalendar_day_cells').html(i),
              ...
              function(a, e, n) {
                  ...
                  for (var u = 0; u < e.length; u++) {
                      ...
                      for (var _ = 0; _ < d.length; _++) title = '""', date = d[_], 'object' == typeof(m = r(n, s, date)) ? (m.title && (title = ' title="' + m.title + '" '), i = '<a href="#" ' + title + '>&nbsp;</a>', c = 'hasEvent', f = m.customClass) : (i = ' ', c = '', f = ''), o += '<td data-date="' + date + '" data-name="' + s + '" class="data_cell ' + c + '' + f + '">' + '$' + 
                      '<span class="price">' + (Math.random()*10000).toFixed(2) + '</span>', 
                        + '</td>';
                      o += '</tr>'
                  }
      ...
      var l = t.extend({
          ...
          template_html: function(t, a) {
              return ['<div class="rescalendar ', t.attr('id'), '_wrapper">', '<div class="rescalendar_controls">', 
              '<button class="move_to_last_month"> Previous month </button>', 
              // '<button class="move_to_yesterday"> < </button>', 
              '<input class="refDate" type="text" value="' + a.refDate + '" />', 
              // '<button class="move_to_tomorrow"> > </button>', 
              '<button class="move_to_next_month"> next month </button>', '<br>', 
              '<button class="move_to_today"> ' + a.lang.today + ' </button>', '</div>', 
              '<table class="rescalendar_table">', 
              '<thead>', 
              '<tr class="rescalendar_day_cells"></tr>', 
              '</thead>', 
              '<tbody class="rescalendar_data_rows">', '</tbody>', 
              '</table>', 
              '</div>'].join('')
          }
      }, a);
